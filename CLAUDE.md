...
- One change = one directory intent/<NNNN>-<slug>/ holding intent.md,
  spec.md, plan.md, committed in that order, one commit each. main was
  squashed to one commit at publication; the pre-publication stage-by-stage
  record is on the history branch and tag v0.1.0.
